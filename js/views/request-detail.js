...
(function () {
    ...
    function collectEdits(root) {
        ...
        root.querySelectorAll('#mdm-edit [name]').forEach(el => {
            ...
            if (n !== 'unspscSel') edits[n] = el.value;   // the picker itself isn't a payload field
        });
        return edits;
    }
    ...
    function renderActionZone(root, req, stage, awaitingMe, isMyRequest) {
        ...
        // PO unit ↔ conversion: the hint always names the two units, and picking
        // the same unit as the base UoM prefills the trivial factor of 1
        ...
        if (poSel && factorInp) {
            ...
            poSel.addEventListener('change', syncFactor);
            if (baseSel) baseSel.addEventListener('change', syncFactor);
            syncFactor();
        }
